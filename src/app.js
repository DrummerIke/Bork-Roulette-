...
const SUPABASE_URL = window.BORK_SUPABASE_URL || 'https://YOUR-PROJECT.supabase.co';
const SUPABASE_ANON_KEY = window.BORK_SUPABASE_ANON_KEY || 'YOUR-SUPABASE-ANON-KEY';
